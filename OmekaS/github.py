...
class GitHubApiClient:
    ...
    def create_metadata(self):
        ...
        if self.limit > 0:
            repository_urls = repository_urls[:self.limit]
        ...
        for repository_url in tqdm(repository_urls):
            ...
            has_advanced_search = self.has_advanced_search(api_repo)

            metadata["has_advanced_search"] = has_advanced_search
    ...
    def has_advanced_search(self, api_repo):
        token = self.token

        response = requests.get(f'{api_repo}/contents/view/common/advanced-search',
                                headers={'Authorization': f'token {token}'})
